...
本手册与 [Part 1《Git学习手册》](./Git学习手册.md) 的职责不同：

- [Part 1《Git学习手册》](./Git学习手册.md) 负责帮助读者理解 Git 的概念、流程和使用场景
...
为与其他 Part 保持一致，本手册默认这样写命令风险：

- Part 2 仍保留统一的 `注意事项` 小节，便于速查
- 如果命令存在误删、历史改写、共享分支影响、敏感信息泄漏或不可逆后果，在 `注意事项` 开头统一使用 `风险提示：`
...
如果你已经知道“要查哪条命令”，就继续留在本手册；如果你还不确定问题属于概念、规范还是工具，可以按下面的路径跳转：

| 当前诉求 | 建议跳转 |
|------|------|
| 先把 Git 概念和流程学明白 | [Part 1《Git学习手册》](./Git学习手册.md) |
| 想把分支、提交、发布和协作习惯稳定下来 | [Part 3《Git个人使用规范》](./Git个人使用规范.md) |
| 想选 GUI、CLI、钩子、安全与自动化工具 | [Part 4《Git实用拓展手册》](./Git实用拓展手册.md) |
| 不确定应该先读哪一本 | [docs 目录导航页](./README.md) |

按命令类别继续联动时，也可以直接这样看：

- 本地仓库命令：联动 [Part 1 本地仓库核心操作](./Git学习手册.md#2-本地仓库核心操作) 与 [Part 3 提交规范](./Git个人使用规范.md#提交规范)
- 远程仓库命令：联动 [Part 1 远程仓库基础交互](./Git学习手册.md#3-远程仓库基础交互) 与 [Part 3 小型协作规范](./Git个人使用规范.md#小型协作规范)
- 分支与合并命令：联动 [Part 1 分支管理与协作](./Git学习手册.md#4-分支管理与协作) 与 [Part 3 分支管理规范](./Git个人使用规范.md#分支管理规范)
- 回滚与恢复命令：联动 [Part 1 回滚、撤销与恢复](./Git学习手册.md#5-回滚撤销与恢复) 与 [Part 3 冲突处理规范](./Git个人使用规范.md#冲突处理规范)
- 标签与发布相关命令：联动 [Part 1 标签与版本标记](./Git学习手册.md#7-标签与版本标记) 与 [Part 3 配套规范](./Git个人使用规范.md#配套规范)
- 配置与查看类命令：联动 [Part 1 Git 简介与安装配置](./Git学习手册.md#1-git-简介与安装配置) 与 [Part 4 高频技巧](./Git实用拓展手册.md#5-高频技巧)
