...
如果你在阅读过程中出现“概念大致懂了，但想继续往下查命令、规范或工具”的情况，可以直接按下面的路径跳转：

| 当前阅读主题 | 建议继续联动 |
|------|------|
| Git 简介与安装配置 | [Part 2 配置与查看类命令](./Git%20Reference手册.md#6-配置与查看类命令)、[Part 4 GUI 与 IDE 工具](./Git实用拓展手册.md#1-gui-与-ide-工具) |
| 本地仓库核心操作 | [Part 2 本地仓库命令](./Git%20Reference手册.md#1-本地仓库命令)、[Part 3 提交规范](./Git个人使用规范.md#提交规范) |
| 远程仓库基础交互 | [Part 2 远程仓库命令](./Git%20Reference手册.md#2-远程仓库命令)、[Part 3 小型协作规范](./Git个人使用规范.md#小型协作规范) |
| 分支管理与协作 | [Part 2 分支与合并命令](./Git%20Reference手册.md#3-分支与合并命令)、[Part 3 分支管理规范](./Git个人使用规范.md#分支管理规范) |
| 回滚、撤销与恢复 | [Part 2 回滚与恢复命令](./Git%20Reference手册.md#4-回滚与恢复命令)、[Part 3 单人开发流程](./Git个人使用规范.md#单人开发流程) |
| 冲突解决 | [Part 2 分支与合并命令](./Git%20Reference手册.md#3-分支与合并命令)、[Part 3 冲突处理规范](./Git个人使用规范.md#冲突处理规范) |
| 标签与版本标记 | [Part 2 标签与发布相关命令](./Git%20Reference手册.md#5-标签与发布相关命令)、[Part 3 配套规范](./Git个人使用规范.md#配套规范) |
| Git 原理 | [Part 2 命令关系速览](./Git%20Reference手册.md#命令关系速览)、[Part 4 高频技巧](./Git实用拓展手册.md#5-高频技巧) |
| 常见问题排查 | [Part 2 关键词索引](./Git%20Reference手册.md#7-关键词索引)、[docs 目录导航页](./README.md) |
...
为与其他 Part 保持一致，本手册默认按以下方式编排风险信息：

- `说明：` 用于补充背景、默认选择、易混点和理解上下文
